...
// How to display the rest of the list of Subjects in the header section
function getMore() {

    // Get the More button
    var x = document.getElementById("moreSubjectss");

    // Shows the list of Subjects when clicked if it is not displayed, otherwise remove it
